...
export const PostFlightsIdAssignmentsBody = zod.object({
  "veteranCount": zod.number().int().min(1).max(postFlightsIdAssignmentsBodyVeteranCountMax).describe('Number of veterans to add from waitlist')
})
...
export const GetRecentActivityQueryParams = zod.object({
  ...
  "offset": zod.number().int().default(getRecentActivityQueryOffsetDefault).describe('Zero-based offset for pagination (number of records to skip)'),
  "limit": zod.number().int().default(getRecentActivityQueryLimitDefault).describe('Maximum number of results to return')
})
...
export const GetWaitlistQueryParams = zod.object({
  ...
  "offset": zod.number().int().default(getWaitlistQueryOffsetDefault).describe('Zero-based offset for pagination (number of records to skip)'),
  "limit": zod.number().int().default(getWaitlistQueryLimitDefault).describe('Maximum number of results to return')
})
